...
def test_build_interpretation_messages_for_version_resolves_v1_and_rejects_unknown():
    ...
    assert set(KNOWN_INTERPRETATION_PROMPT_VERSIONS) == {"risk_interpretation_v1"}
