"""
Local fixtures for workplace tests, mirroring key_assets/tests/conftest.py
1:1 (two synthetic organisations, two users, one membership each, two
logged-in clients), which itself mirrors organisations/tests/conftest.py.
Duplicated rather than imported across the app boundary, matching this
