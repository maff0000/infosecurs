...
*about* the organisation's security state, evaluated and linked to controls
only by a later, separate dispatch (`ControlEvidenceLink`, out of scope
here - see the M003 PID §6.4 and this dispatch's own scope notes).
